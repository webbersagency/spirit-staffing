            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                <div className="mx-auto max-w-2xl lg:text-center">
                    ...
                    <p className="mt-6 text-lg leading-8">
                        De digitale transitie geeft de samenleving veel kansen, maar vraagt ook om zorgvuldigheid. Met
                        het uitbreiden van de digitale wereld, nemen ook de risico’s in dit domein toe. Daarom
