                ...
                <div className="relative lg:static">
                    <div className="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
                        ...
                        <div className={classNames(slideInLeft(inView))}>
                            <h2 className="text-3xl font-medium tracking-tight sm:text-5xl">Stuur ons een bericht </h2>
                            <p className="mt-6 leading-6">
                                ...
                                mogelijkheden die bij jou passen.
                            </p>
                    ...
                    <div className={classNames('mx-auto max-w-xl lg:mr-0 ', slideInBottom(inView))}>
                        <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                            ...
                            <div className="sm:col-span-2">
                                ...
                                <div id="contactform" className="mt-2.5">
                                    <textarea
                                        name="message"
                                        id="message"
                                        rows={4}
